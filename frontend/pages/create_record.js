...
export default function CreateData() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:8000/bio_sample/`, {
                method: 'POST',
                headers: {
            ...
            setResponseMessage('Failed to create record.');
        }
    };
    ...
    return (
        <div className={styles.container}>
            <Head>
                <title>Create Biological Sample Data</title>
                <link rel="icon" href="/bat.png" />
            </Head>

            <main>
                <h1 className={styles.title}>
                    Create Biological Sample Data
                </h1>
